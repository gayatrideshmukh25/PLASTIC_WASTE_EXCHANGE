...
const {userDashboard,sendRequest,nearestCollector,postRequest,rewards,redeemCoupon, applyCoupon, productPage } = require('../controller/userController');
...
userRouter.post('/userDashboard/apply-coupon',isAuthenticated,applyCoupon);
userRouter.post('/products',isAuthenticated,productPage);
